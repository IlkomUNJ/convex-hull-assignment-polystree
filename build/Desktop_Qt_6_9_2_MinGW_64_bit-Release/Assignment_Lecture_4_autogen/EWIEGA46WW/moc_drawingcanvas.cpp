...
template <> constexpr inline auto DrawingCanvas::qt_create_metaobjectdata<qt_meta_tag_ZN13DrawingCanvasE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'setAutoModeSlow'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'setAutoModeHull'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'setAutoModeBoth'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'setAutoModeNone'
...
void DrawingCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->setAutoModeSlow(); break;
        case 1: _t->setAutoModeHull(); break;
        case 2: _t->setAutoModeBoth(); break;
        case 3: _t->setAutoModeNone(); break;
        default: ;
        }
    }
    (void)_a;
